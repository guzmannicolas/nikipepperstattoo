...
const $$Works = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": `${t("artworks.title")} - Niki Peppers`, "description": t("artworks.description") }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="py-20 px-4 max-w-7xl mx-auto"> <div class="text-center mb-16"> <h1 class="text-5xl font-bold mb-4 text-black"> ${t("artworks.title")} </h1> <p class="text-neutral-600 text-lg max-w-2xl mx-auto"> ${t("artworks.description")} </p> </div> ${renderComponent($$result2, "GalleryPlus", $$GalleryPlus, { "items": galleryItems, "showInitialCount": 6, "loadMoreLabel": t("tattoos.loadMore") }, { "filters": ($$result3) => renderTemplate`<div> ${(() => {
    const buttons = [
      {
      ...
      {
        label: t("artworks.filters.on_demand") || "A pedido",
        value: "on_demand"
      }
    ];
...
}, "C:/xampp/htdocs/nikipepperstattoo/src/pages/es/works.astro", void 0);

const $$file = "C:/xampp/htdocs/nikipepperstattoo/src/pages/es/works.astro";
const $$url = "/es/works";

...
const $$Ceramics = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": `${t("ceramics.title")} - Niki Peppers`, "description": t("ceramics.description"), "data-astro-cid-7bgzibnw": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="py-20 px-4 max-w-7xl mx-auto" data-astro-cid-7bgzibnw> <div class="text-center mb-16" data-astro-cid-7bgzibnw> <h1 class="text-5xl font-bold mb-4 text-black" data-astro-cid-7bgzibnw> ${t("ceramics.title")} </h1> <p class="text-neutral-600 text-lg max-w-2xl mx-auto" data-astro-cid-7bgzibnw> ${t("ceramics.description")} </p> </div> <!-- Unified Gallery component (replaces manual grid + lightbox) --> ${renderComponent($$result2, "Gallery", $$Gallery, { "items": galleryItems, "id": "ceramics-gallery", "showInitialCount": 6, "loadMoreLabel": t("ceramics.loadMore"), "data-astro-cid-7bgzibnw": true }, { "filters": ($$result3) => renderTemplate`<div data-astro-cid-7bgzibnw> ${(() => {
    const buttons = [
      {
    ...
    return renderTemplate`${renderComponent($$result3, "FilterButtons", $$FilterButtons, { "buttons": buttons, "data-astro-cid-7bgzibnw": true })}`;
  })()} </div>` })} </section>  ${renderComponent($$result2, "AboutCeramicsSection", $$AboutCeramicsSection, { "t": t, "data-astro-cid-7bgzibnw": true })}  ${renderComponent($$result2, "CTASection", $$CTASection, { "lang": lang, "t": t, "ns": "ceramics", "data-astro-cid-7bgzibnw": true })} ${renderComponent($$result2, "CrossPromo", $$CrossPromo, { "lang": lang, "data-astro-cid-7bgzibnw": true })}  ` })}`;
}, "C:/xampp/htdocs/nikipepperstattoo/src/pages/es/ceramics.astro", void 0);

const $$file = "C:/xampp/htdocs/nikipepperstattoo/src/pages/es/ceramics.astro";
const $$url = "/es/ceramics";
